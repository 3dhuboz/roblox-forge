...
import { checkBrowserAiKey } from "../../services/browserPreviewAi";
...
function checklistSafeMessage(
  ...
  const containsCredential =
    ...
    /(?:bearer|password|secret|token|api[_ -]?key)\s*[:=]\s*\S+/i.test(trimmed);
...
const templates: Template[] = [
  {
    ...
    name: "Obby",
    description:
      "Obstacle course with stages, checkpoints, and kill bricks. Jump your way to victory!",
    icon: Mountain,
    available: true,
    color: "bg-green-600",
  },
  {
    ...
    name: "Tycoon",
    description:
      "Build your empire! Collect resources, buy upgrades, and grow your business.",
    icon: Factory,
    available: true,
    color: "bg-yellow-600",
  },
  {
    ...
    name: "Simulator",
    description:
      "Click, collect, and upgrade! With pets, rebirths, and endless progression.",
    icon: Zap,
    available: true,
    color: "bg-purple-600",
  },
  ...
  },
  {
    ...
    name: "RPG",
    description:
      "Adventure with quests, leveling, gear, and a world to explore.",
    icon: Map,
    available: true,
    color: "bg-blue-600",
  },
  {
    ...
    name: "Horror",
    description:
      "Scary adventures with puzzles, jumpscares, and dark atmospheres.",
    icon: Ghost,
    available: true,
    color: "bg-gray-600",
  },
  {
    ...
    name: "Racing",
    description:
      "High-speed vehicle racing with tracks, upgrades, and multiplayer.",
    icon: Car,
    available: true,
    color: "bg-orange-600",
  },
...
function RobloxChar({
  ...
  return (
    <div
      className="absolute"
      style={{ left: x, bottom, transform: flip ? "scaleX(-1)" : "none" }}
    >
      {/* Head */}
      <div
        style={{
      ...
      return (
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 80%, #00ff8840, transparent 60%)",
            }}
          />
          {/* Neon platforms staircase */}
          <div
            className="absolute bottom-2 left-[5%] h-4 w-[25%] rounded"
            style={{
          ...
          />
          <div
            className="absolute bottom-8 left-[20%] h-4 w-[22%] rounded"
            style={{
              background: "linear-gradient(90deg, #00bbff, #0088ff)",
              boxShadow: "0 0 12px #00bbff66",
            }}
          />
          <div
            className="absolute bottom-14 left-[10%] h-4 w-[20%] rounded"
            style={{
              background: "linear-gradient(90deg, #ff44cc, #ff0088)",
              boxShadow: "0 0 12px #ff44cc66",
            }}
          />
          <div
            className="absolute bottom-20 right-[15%] h-4 w-[22%] rounded"
            style={{
              background: "linear-gradient(90deg, #ffaa00, #ff8800)",
              boxShadow: "0 0 12px #ffaa0066",
            }}
          />
          {/* Kill brick (red glow) */}
          <div
            className="absolute bottom-5 left-[48%] h-3 w-[12%] rounded-sm"
            style={{ background: "#ff0000", boxShadow: "0 0 10px #ff000088" }}
          />
          {/* Character jumping */}
      ...
      return (
        <div className="absolute inset-0">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 70%, #ffd70040, transparent 60%)",
            }}
          />
          {/* Factory silhouette */}
          <div
            className="absolute bottom-0 left-[5%] h-[55%] w-[35%] rounded-t"
            style={{ background: "linear-gradient(180deg, #666, #444)" }}
          >
          ...
          {[25, 40, 55, 68, 80, 90].map((l, i) => (
            ...
            >
              <span className="flex items-center justify-center text-[6px] font-bold text-amber-800">
                $
              </span>
            </div>
          ))}
          ...
          <div
            ...
            style={{ color: "#00ff88", textShadow: "0 0 10px #00ff8888" }}
          >
            ⬆
          </div>
        </div>
      ...
      return (
        <div className="absolute inset-0">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 30% 60%, #aa55ff40, transparent 50%), radial-gradient(ellipse at 70% 40%, #ff55aa30, transparent 50%)",
            }}
          />
          {/* Big pet (golden) */}
          <div
            ...
            style={{
              ...
              height: "32px",
              background:
                "radial-gradient(circle at 40% 35%, #ffd700, #ff8c00)",
              borderRadius: "40%",
          ...
          {/* Small pets */}
          <div
            className="absolute bottom-6 left-[15%] h-5 w-5 rounded-full shadow"
            style={{ background: "#ff69b4", boxShadow: "0 0 8px #ff69b466" }}
          />
          <div
            className="absolute bottom-4 left-[30%] h-4 w-4 rounded-full shadow"
            style={{ background: "#00ddff", boxShadow: "0 0 8px #00ddff66" }}
          />
          {/* Character */}
          ...
          {/* Sparkles */}
          <div
            className="absolute top-2 left-[20%] text-sm"
            style={{ textShadow: "0 0 8px #fff" }}
          >
            ✨
          </div>
          <div
            className="absolute top-4 right-[25%] text-lg"
            style={{ textShadow: "0 0 8px #fff" }}
          >
            ✨
          </div>
      ...
      return (
        <div className="absolute inset-0">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 50%, #ff440030, transparent 50%)",
            }}
          />
          {/* Arena ground */}
          <div
            className="absolute bottom-0 inset-x-0 h-[30%]"
            style={{ background: "linear-gradient(180deg, #4a2020, #2a1010)" }}
          />
          {/* Blue fighter */}
          ...
          {/* VS text */}
          <div
            className="absolute top-2 left-1/2 -translate-x-1/2 text-lg font-black"
            style={{
              color: "#ff4444",
              textShadow: "0 0 10px #ff000088, 2px 2px 0 #000",
            }}
          >
            VS
          </div>
          {/* Health bars */}
          <div className="absolute top-3 left-3 h-2 w-[30%] rounded-full bg-gray-800">
            <div
              className="h-2 w-[75%] rounded-full"
              style={{
                background: "linear-gradient(90deg, #00ff00, #88ff00)",
                boxShadow: "0 0 6px #00ff0066",
              }}
            />
          </div>
          <div className="absolute top-3 right-3 h-2 w-[30%] rounded-full bg-gray-800">
            <div
              className="h-2 w-[55%] rounded-full float-right"
              style={{
                background: "linear-gradient(90deg, #ff8800, #ff0000)",
                boxShadow: "0 0 6px #ff000066",
              }}
            />
          </div>
        </div>
      ...
      return (
        <div className="absolute inset-0">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 30% 30%, #4488ff30, transparent 50%), radial-gradient(ellipse at 70% 70%, #44ff4420, transparent 50%)",
            }}
          />
          {/* Green ground */}
          <div
            className="absolute bottom-0 inset-x-0 h-[25%]"
            style={{ background: "linear-gradient(180deg, #2d6a2d, #1a4a1a)" }}
          />
          {/* Castle */}
            ...
            >
              <div className="flex gap-0.5 -mt-1" style={{ padding: "0 2px" }}>
                {[0, 1, 2, 3].map((i) => (
                  <div
                    key={i}
                    style={{ width: "7px", height: "6px", background: "#888" }}
                  />
                ))}
              </div>
            </div>
          ...
          <div
            className="absolute bottom-[22%] left-[62%]"
            style={{
              width: "3px",
              height: "24px",
              background: "linear-gradient(180deg, #ccc, #888)",
              transform: "rotate(-30deg)",
              boxShadow: "0 0 6px #ffffff44",
            }}
          >
            <div
              style={{
    ...
    case "horror":
      return (
        <div className="absolute inset-0">
          <div
            className="absolute inset-0"
            style={{ background: "linear-gradient(180deg, #0a0a15, #1a1020)" }}
          />
          {/* Moon */}
          <div
            ...
            style={{
              width: "24px",
              height: "24px",
              background: "radial-gradient(circle at 40% 40%, #eee, #aaa)",
              borderRadius: "50%",
          ...
          <div
            ...
            style={{ width: "50px", height: "60px", background: "#222" }}
          >
            <div
              className="-mt-3 -ml-1"
              style={{
          ...
          <div
            ...
            style={{
              width: "20px",
              height: "30px",
              background: "linear-gradient(180deg, #ff000015, #33003310)",
              borderRadius: "6px 6px 0 0",
              boxShadow: "0 0 15px #ff000020",
            }}
          >
            <div
              className="absolute"
          ...
          <div
            ...
            style={{
              background: "linear-gradient(180deg, transparent, #ffffff08)",
            }}
          />
        </div>
      );
      ...
      return (
        <div className="absolute inset-0">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 90%, #ff880030, transparent 50%)",
            }}
          />
          {/* Sky */}
          <div
            className="absolute inset-x-0 top-0 h-[50%]"
            style={{ background: "linear-gradient(180deg, #1a3a6a, #3a6a9a)" }}
          />
            ...
            {[0, 1, 2].map((i) => (
              <div
                ...
                style={{
                  width: `${10 - i * 3}px`,
                  height: "2px",
                  background: `rgba(255,200,0,${0.6 - i * 0.15})`,
                }}
              />
            ))}
          </div>
      ...
      return (
        <div className="absolute inset-0">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 50%, #ff55aa25, transparent 50%), radial-gradient(ellipse at 30% 30%, #55aaff20, transparent 40%), radial-gradient(ellipse at 70% 70%, #ffaa5520, transparent 40%)",
            }}
          />
          {/* Party characters */}
          ...
          {/* "PARTY" vibe */}
          <div
            className="absolute top-2 right-3 text-[10px] font-black tracking-wide"
            style={{ color: "#ffaa00", textShadow: "0 0 8px #ffaa0088" }}
          >
            PLAY!
          </div>
        </div>
...
function SetupChecklist({ hasProjects }: { hasProjects: boolean }) {
  ...
  const [dismissed, setDismissed] = useState(() => {
    try {
      return localStorage.getItem("roblox-forge-setup-dismissed") === "true";
    } catch {
      return false;
    }
  });
      ...
      .then((provider) => {
        ...
        if (provider) {
          ...
          setApiState({
            status: "configured",
            hint: desktopRuntime
              ? `AI key verified by RobloxForge Desktop (${label}).`
              : `${label} connected for this browser tab.`,
            provider: label,
          });
          ...
          setApiState({
            ...
            hint: desktopRuntime
              ...
              : "Connect an OpenRouter key in Settings for browser AI.",
            provider: null,
          });
        }
      })
      ...
      <div className="mt-3.5 space-y-2">
        {items.map((item) => {
          ...
          return (
            <div
              key={item.label}
              className="flex items-center gap-3 rounded-xl bg-gray-900/50 px-3.5 py-2.5"
            >
              {item.done ? (
              ...
              <Icon
                ...
                className={
                  item.done
                    ? "shrink-0 text-green-400/60"
                    : "shrink-0 text-gray-500"
                }
              />
              <div className="min-w-0 flex-1">
                <p
                  className={`text-[13px] font-medium ${item.done ? "text-gray-500 line-through" : "text-gray-200"}`}
                >
                  {item.label}
                </p>
                <p
...
export function TemplateSelector() {
  ...
  const [recentProjects, setRecentProjects] =
    useState<RecentProject[]>(getRecentProjects);
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="px-8 pt-8 pb-2">
        <h1 className="text-2xl font-bold text-white">
          {profile.displayName
            ? `What should we make, ${profile.displayName}?`
      ...
      <div className="flex-1 overflow-y-auto px-8 py-4">
        ...
        {hasOpenProject && (
          <div className="mb-6">
            ...
            >
              <div
                className={`flex h-14 w-14 items-center justify-center rounded-xl shadow-lg ${TEMPLATE_COLOR_MAP[project!.template] || "bg-indigo-600"}`}
              >
                {(() => {
                  const Icon = TEMPLATE_ICON_MAP[project!.template] || Mountain;
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-indigo-300/70">
                  Keep building your {project!.template}
                </p>
              </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-2 lg:grid-cols-3 xl:grid-cols-4">
              {recentProjects.map((recent) => {
                ...
                const color =
                  TEMPLATE_COLOR_MAP[recent.template] || "bg-gray-600";
                return (
                  <div
                    key={recent.path}
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] text-gray-500">
                          {recent.template} &middot; {timeAgo(recent.createdAt)}
                        </p>
                      </div>
                    </button>
                    <button
          ...
          {templates.map((template) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`relative h-28 overflow-hidden ${template.color}`}
                >
          ...
          <div className="mx-auto flex max-w-xl items-end gap-3">
            <div className="flex-1">
              ...
              <input
                ...
                placeholder={
                  selectedTemplate === "tycoon"
                    ? "My Factory Empire"
                    : selectedTemplate === "rpg"
                      ? "Dragon Quest Adventure"
                      : selectedTemplate === "horror"
                        ? "The Haunted Mansion"
                        : selectedTemplate === "racing"
                          ? "Speed Legends"
                          : selectedTemplate === "minigames"
                            ? "Party Games Hub"
                            : selectedTemplate === "battlegrounds"
                              ? "Epic Battles"
